...
class JumpAsymptDataLoader(dict):
    def __init__(self, root, voxel_size, num_points, **kwargs):
        ...
        if submit_to_server:
            super(JumpAsymptDataLoader, self).__init__({
                'train':
                modifyPointCloudSemanticKITTIInternal(root,
                                      voxel_size,
                                      num_points,
                                      sample_stride=1,
                                      split='train',
...
class modifyPointCloudSemanticKITTIInternal:
    def __init__(self,
                 root,
                 voxel_size,
                 num_points,
    ...
    def __getitem__(self, index):
        ...
        # TODO modify coords here

        # Dataloader for Asymptote
